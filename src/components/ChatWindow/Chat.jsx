...
const Message = ({ text }) => {
  return (
    <div className='p-6 border-t border-t-slate-200'>
...
const MessagesContainer = ({ children, className }) => {
...
const ChatWindow = ({ className, children }) => {
  return (
...
const Chat = ({ className }) => {
  return (
    // <Example2 />
    // <Example />
    <ChatWindow className='  h-full flex flex-col w-full'>
...
function Example2() {
  ...
  return (
    ...
    <nav className="h-96 overflow-y-auto grow w-full" aria-label="Directory">
      {Object.keys(directory).map((letter) => (
        <div key={letter} className="relative grow">
